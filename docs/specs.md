...
Επιστρέφει όλα τα project στα οποία συμμετέχει ο χρήστης με id {user_id} σε μορφή json.

`[GET] /projects/{project_id}/users`

Επιστρέφει όλους του χρήστες που συμμετέχουν στο project με id {project_id} σε μορφή json.
...
Επιστρέφει "YES" αν ο χρήστης με {username} υπάρχει στο project με id {id} διαφορετικά επιστρέφει "NO".

`[GET] /users/name={username}`

Επιστρέφει σε μορφή json τον χρήστη με username {username}, αν ο χρήστης δεν υπάρχει τα στοιχεία του json έχουν τιμές null.

`[PUT] /projects/{id}/archive`

Αλλάζει την κατάσταση του project με id {id} από IN_PROGRESS σε DONE.
